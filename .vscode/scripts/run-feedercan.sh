...
ROOT_DIRECTORY="/workspaces/car-health-check-vadf"
...
CONFIG_DIR="$ROOT_DIRECTORY/.vscode/scripts/default"
...
if [ $2 = "DOGMODE" ]; then
  ...
  export DBC_FILE="$CONFIG_DIR/Model3CAN.dbc"
  export MAPPING_FILE="$CONFIG_DIR/mapping.yml"
  export CANDUMP_FILE="$CONFIG_DIR/candump.log"
fi
